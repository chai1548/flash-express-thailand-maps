...
const ReceivePackage = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    senderAddress: "",
    senderPhone: "",
    recipientName: isLoggedIn() ? getCurrentUser()?.name || "" : "",
    recipientAddress: "",
    recipientPhone: "",
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    try {
      ...
      addPackage({
        ...
        history: [
          {
            status: "Package scheduled for pickup",
      ...
      // Success message
      toast.success("Package reception scheduled successfully", {
      ...
      toast.error("Failed to schedule package reception");
    } finally {
      ...
      <main className="flex-grow bg-gray-50 py-8">
        <div className="container mx-auto px-4">
          <div className="flex items-center mb-6">
            <Package size={28} className="text-flash-primary mr-3" />
            <h1 className="text-2xl md:text-3xl font-bold">Receive a Package</h1>
          </div>
          ...
          <Card>
            <CardContent className="pt-6">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <h2 className="text-xl font-semibold mb-4 text-flash-primary">Recipient Information (You)</h2>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                ...
                <div className="flex justify-end pt-4">
                  ...
                  >
                    ...
                    {isSubmitting ? "Scheduling..." : "Schedule Package Reception"}
                  </Button>
                </div>
              </form>
            </CardContent>
